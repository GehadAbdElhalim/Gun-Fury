...
public class EnemyMiniGunScript : MonoBehaviour
{
        ...
        if (state == 2)
        {
            if(currentDelay > 0)
            {
                ...
                if (canContinue)
                {
                    ...
                    {
                        transform.RotateAroundLocal(transform.up, 1 * Time.deltaTime);
                    }
                    else
                    {
                        transform.RotateAroundLocal(transform.up, -1 * Time.deltaTime);
